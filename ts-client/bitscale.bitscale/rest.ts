...
export type MsgDeleteDenomResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @tags Query
   * @name QueryDenomAll
   * @request GET:/bitscale/bitscale/denom
   */
  queryDenomAll = (
    query?: {
   ...
   * @tags Query
   * @name QueryDenom
   * @request GET:/bitscale/bitscale/denom/{denom}
   */
  queryDenom = (denom: string, params: RequestParams = {}) =>
    this.request<
      ...
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
      path: `/bitscale/bitscale/denom/${denom}`,
      method: "GET",
      ...params,
    });
