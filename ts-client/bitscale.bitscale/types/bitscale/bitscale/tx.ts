...
export const MsgDeleteDenom = {
  ...
  create<I extends Exact<DeepPartial<MsgDeleteDenom>, I>>(base?: I): MsgDeleteDenom {
    return MsgDeleteDenom.fromPartial(base ?? ({} as any));
  },
...
export const MsgServiceName = "bitscale.bitscale.Msg";
