...
export { QueryAllDenomRequest, MsgUpdateDenom, BitscalePacketData, MsgUpdateParamsResponse, MsgCreateDenomResponse, Denom, MsgCreateDenom, MsgDeleteDenom, NoData, MsgDeleteDenomResponse, QueryParamsResponse, MsgUpdateDenomResponse, QueryGetDenomResponse, QueryAllDenomResponse, GenesisState, MsgUpdateParams, Params, QueryParamsRequest, QueryGetDenomRequest };
...
type sendBitscalePacketDataParams = {
  value: BitscalePacketData,
  fee?: StdFee,
  memo?: string
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendBitscalePacketData({ value, fee, memo }: sendBitscalePacketDataParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendBitscalePacketData: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.bitscalePacketData({ value: BitscalePacketData.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendBitscalePacketData: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		queryAllDenomRequest({ value }: queryAllDenomRequestParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.QueryAllDenomRequest", value: QueryAllDenomRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateDenom({ value }: msgUpdateDenomParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgUpdateDenom", value: MsgUpdateDenom.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgUpdateDenom: Could not create message: ' + e.message)
			}
		},
		
		bitscalePacketData({ value }: bitscalePacketDataParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.BitscalePacketData", value: BitscalePacketData.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:BitscalePacketData: Could not create message: ' + e.message)
			}
		},
		
		msgUpdateParamsResponse({ value }: msgUpdateParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgUpdateParamsResponse", value: MsgUpdateParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateDenomResponse({ value }: msgCreateDenomResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgCreateDenomResponse", value: MsgCreateDenomResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		denom({ value }: denomParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.Denom", value: Denom.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgCreateDenom({ value }: msgCreateDenomParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgCreateDenom", value: MsgCreateDenom.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeleteDenom({ value }: msgDeleteDenomParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgDeleteDenom", value: MsgDeleteDenom.fromPartial( value ) }  
			} catch (e: any) {
		...
		noData({ value }: noDataParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.NoData", value: NoData.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDeleteDenomResponse({ value }: msgDeleteDenomResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgDeleteDenomResponse", value: MsgDeleteDenomResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsResponse({ value }: queryParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.QueryParamsResponse", value: QueryParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateDenomResponse({ value }: msgUpdateDenomResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgUpdateDenomResponse", value: MsgUpdateDenomResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryGetDenomResponse({ value }: queryGetDenomResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.QueryGetDenomResponse", value: QueryGetDenomResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryAllDenomResponse({ value }: queryAllDenomResponseParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.QueryAllDenomResponse", value: QueryAllDenomResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		genesisState({ value }: genesisStateParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.GenesisState", value: GenesisState.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParams({ value }: msgUpdateParamsParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.MsgUpdateParams", value: MsgUpdateParams.fromPartial( value ) }  
			} catch (e: any) {
		...
		params({ value }: paramsParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.Params", value: Params.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsRequest({ value }: queryParamsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.QueryParamsRequest", value: QueryParamsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryGetDenomRequest({ value }: queryGetDenomRequestParams): EncodeObject {
			try {
				return { typeUrl: "/bitscale.bitscale.QueryGetDenomRequest", value: QueryGetDenomRequest.fromPartial( value ) }  
			} catch (e: any) {
...
const IgntModule = (test: IgniteClient) => {
	return {
		module: {
			BitscaleBitscale: new SDKModule(test)
		},
		registry: msgTypes
  }
}
