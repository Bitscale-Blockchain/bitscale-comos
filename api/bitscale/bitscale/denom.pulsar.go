...
func init() {
	...
	md_Denom = File_bitscale_bitscale_denom_proto.Messages().ByName("Denom")
...
func (x *Denom) slowProtoReflect() protoreflect.Message {
	mi := &file_bitscale_bitscale_denom_proto_msgTypes[0]
...
func (x *fastReflection_Denom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bitscale.bitscale.Denom.denom":
		return x.Denom != ""
	case "bitscale.bitscale.Denom.description":
		return x.Description != ""
	case "bitscale.bitscale.Denom.ticker":
		return x.Ticker != ""
	case "bitscale.bitscale.Denom.precision":
		return x.Precision != int32(0)
	case "bitscale.bitscale.Denom.url":
		return x.Url != ""
	case "bitscale.bitscale.Denom.maxSupply":
		return x.MaxSupply != int32(0)
	case "bitscale.bitscale.Denom.supply":
		return x.Supply != int32(0)
	case "bitscale.bitscale.Denom.canChangeMaxSupply":
		return x.CanChangeMaxSupply != false
	case "bitscale.bitscale.Denom.owner":
		return x.Owner != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bitscale.bitscale.Denom"))
		}
		panic(fmt.Errorf("message bitscale.bitscale.Denom does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Denom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bitscale.bitscale.Denom does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Denom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "bitscale.bitscale.Denom.denom":
		panic(fmt.Errorf("field denom of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.description":
		panic(fmt.Errorf("field description of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.ticker":
		panic(fmt.Errorf("field ticker of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.precision":
		panic(fmt.Errorf("field precision of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.url":
		panic(fmt.Errorf("field url of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.maxSupply":
		panic(fmt.Errorf("field maxSupply of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.supply":
		panic(fmt.Errorf("field supply of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.canChangeMaxSupply":
		panic(fmt.Errorf("field canChangeMaxSupply of message bitscale.bitscale.Denom is not mutable"))
	case "bitscale.bitscale.Denom.owner":
		panic(fmt.Errorf("field owner of message bitscale.bitscale.Denom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bitscale.bitscale.Denom"))
		}
...
func (x *fastReflection_Denom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bitscale.bitscale.Denom", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: bitscale/bitscale/denom.proto
...
func (*Denom) Descriptor() ([]byte, []int) {
	return file_bitscale_bitscale_denom_proto_rawDescGZIP(), []int{0}
}
...
var File_bitscale_bitscale_denom_proto protoreflect.FileDescriptor

var file_bitscale_bitscale_denom_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x62, 0x69, 0x74, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x2f, 0x62, 0x69, 0x74, 0x73, 0x63,
	0x61, 0x6c, 0x65, 0x2f, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x11, 0x62, 0x69, 0x74, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x2e, 0x62, 0x69, 0x74, 0x73, 0x63, 0x61,
	0x6c, 0x65, 0x22, 0x83, 0x02, 0x0a, 0x05, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x12, 0x14, 0x0a, 0x05,
	...
	,
}

var (
	file_bitscale_bitscale_denom_proto_rawDescOnce sync.Once
	file_bitscale_bitscale_denom_proto_rawDescData = file_bitscale_bitscale_denom_proto_rawDesc
)

func file_bitscale_bitscale_denom_proto_rawDescGZIP() []byte {
	file_bitscale_bitscale_denom_proto_rawDescOnce.Do(func() {
		file_bitscale_bitscale_denom_proto_rawDescData = protoimpl.X.CompressGZIP(file_bitscale_bitscale_denom_proto_rawDescData)
	})
	return file_bitscale_bitscale_denom_proto_rawDescData
}

var file_bitscale_bitscale_denom_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bitscale_bitscale_denom_proto_goTypes = []interface{}{
	(*Denom)(nil), // 0: bitscale.bitscale.Denom
}
var file_bitscale_bitscale_denom_proto_depIdxs = []int32{
...
func init() { file_bitscale_bitscale_denom_proto_init() }
func file_bitscale_bitscale_denom_proto_init() {
	if File_bitscale_bitscale_denom_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bitscale_bitscale_denom_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Denom); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bitscale_bitscale_denom_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bitscale_bitscale_denom_proto_goTypes,
		DependencyIndexes: file_bitscale_bitscale_denom_proto_depIdxs,
		MessageInfos:      file_bitscale_bitscale_denom_proto_msgTypes,
	}.Build()
	File_bitscale_bitscale_denom_proto = out.File
	file_bitscale_bitscale_denom_proto_rawDesc = nil
	file_bitscale_bitscale_denom_proto_goTypes = nil
	file_bitscale_bitscale_denom_proto_depIdxs = nil
}
